...
13. **Given a network topology, apply link-state routing or distance vector routing algorithm to compute the minimum-cost path [Link-state](https://www.youtube.com/watch?v=_lHSawdgXpI), [distance vector](https://www.youtube.com/watch?v=x9WIQbaVPzY)**
